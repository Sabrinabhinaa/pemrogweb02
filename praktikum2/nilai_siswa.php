...
<html lang="en">
  ...
  <body>
    ...
    <h2>Form Nilai Siswa</h2>
        ...
        <div class="form-group row">
            <label for="praktik" class="col-md-4 col-sm-12 col-form-label">Nilai Tugas/Praktik</label> 
            <div class="col-md-8 col-sm-6">
            <input id="praktik" name="praktik" placeholder="Nilai Tugas" type="number" class="form-control">
            </div>
        </div> 
        <div class="form-group row">
