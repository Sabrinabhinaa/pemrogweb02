...
<form method="POST">
  ...
  Nilai Praktikum : <input type="text" name="nilai" value="" size="6"><br>
...
elseif ($nilai >= 70 && $nilai <= 84) $grade = "B";
elseif ($nilai >= 56 && $nilai <= 69) $grade = "C";
elseif ($nilai >= 36 && $nilai <= 55) $grade = "D";
elseif ($nilai >= 0 && $nilai <= 35) $grade = "E";
else $grade = "";
